    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <AnimateOnScroll>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-display font-bold text-xl text-white">Media<span className="gradient-brand-text">Sale</span></span>
            </div>
            <p className="text-sm text-white/40 leading-relaxed max-w-xs">MediaSale: a IA que encontra os melhores produtos para você em todas as lojas online.</p>
          </div>
          <div>
        ...
        <div className="pt-10 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-white/10">
          <p className="text-xs text-white/30">&copy; {new Date().getFullYear()} MediaSale. Todos os direitos reservados.</p>
