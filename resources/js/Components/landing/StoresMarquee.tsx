...
export const StoresMarquee: React.FC = () => {
  return (
    <section className="py-14 sm:py-16 bg-gradient-to-b from-purple-soft/48 via-purple-soft/56 to-purple-soft/52 overflow-hidden">
      <AnimateOnScroll className="max-w-7xl mx-auto px-4 mb-6">
        <p className="text-xs font-semibold text-muted uppercase tracking-widest text-center">
          Comparando produtos nas principais lojas
        </p>
      </AnimateOnScroll>
        ...
        <div className="marquee-track">
          <div className="flex flex-nowrap items-center">
            {STORES.map((store) => (
              <div
                key={`a-${store}`}
                className="flex-shrink-0 mx-6 px-6 py-2.5 bg-surface-alt/95 border border-brand-default rounded-xl shadow-md shadow-brand/10"
              >
