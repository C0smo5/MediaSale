...
import SettingsSectionDropdown from '@/Components/settings/SettingsSectionDropdown';
...
export function AccountSettingsPanel({
    ...
    const activeSettingsSection = sections.find((s) => s.key === activeSection) ?? sections[0];
    ...
    const settingsShell = (
        <div
            ...
            style={{
                ...
                boxShadow: embedded ? '0 4px 24px rgba(124,58,237,0.06)' : undefined,
            }}
        >
            <div
                ...
                style={{
                    ...
                    background: 'linear-gradient(135deg, #f0eeff 0%, #ffffff 70%)',
                }}
            >
                {embedded ? (
                    <>
                        ...
                        <h2 className="mt-1 text-base font-bold" style={{ color: '#1a1040' }}>
            ...
            <div className="min-w-0 space-y-4 p-4 sm:p-6 lg:p-8">
                {renderSection()}
            </div>
        </div>
    );
    ...
    return (
        <div
            className="min-h-0 min-w-0 overflow-x-hidden px-4 py-6 sm:px-6 sm:py-8 lg:px-8"
                ...
                >
                    ...
                    >
                        <div className="flex items-center gap-4">
                            <span
                                className="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-2xl border-4 border-white text-white shadow-lg"
                                style={{ background: 'linear-gradient(135deg,#5b21b6,#7c3aed)' }}
                            >
                                <SettingsIcon />
                            </span>
                            <div className="min-w-0">
                                <h1 className="truncate text-xl font-bold text-white sm:text-2xl">Configuracoes</h1>
                                <p className="mt-1 text-sm text-white/80">Preferencias da conta, notificacoes e seguranca</p>
                            </div>
                        </div>
                    </div>
                </div>
